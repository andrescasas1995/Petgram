  ...
  return (
    ...
    >
      <defs>
        ...
        >
          <stop offset={0} stopColor="#b500ff" />
        ...
        <filter
          ...
          height="300%"
        >
          <feFlood floodColor="#5abac2" result="flood" />
          <feComposite
            operator="in"
            in2="SourceAlpha"
            in="flood"
            result="shadow"
          />
          <feOffset dx={2.1} dy={-1.6} in="SourceGraphic" result="offset-1" />
          <feOffset dx={-2.1} dy={1.6} in="shadow" result="offset-2" />
          <feMerge>
